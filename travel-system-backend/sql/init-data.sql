...
INSERT IGNORE INTO `scenic_spot` (
  `id`, `name`, `city_id`, `address`, `latitude`, `longitude`, `intro`,
  `open_time`, `ticket_info`, `score`, `hot_score`, `is_recommend`,
...
(9, '西湖', 5, '浙江省杭州市西湖区', 30.250000, 120.130000, '西湖，位于浙江省杭州市西湖区龙井路1号，杭州市区西部，是中国首批国家重点风景名胜区。', '全天开放', '免费', 4.9, 16000, 1, NOW(), NOW(), 0),
...
INSERT IGNORE INTO `food` (
  ...
  `food_type`, `avg_price`, `intro`, `score`, `hot_score`, `is_recommend`,
  `create_time`, `update_time`, `del_flag`
) VALUES
